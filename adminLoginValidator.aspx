<script language="C#" runat=server>
        private bool validator (string un, string pw){
            ...
            OleDbConnection dbconn = new OleDbConnection("Provider==SQLXMLOLEDB.4.0; Data Provider = SQLNCLI10; Data Source=tcp:ufwryy6r0y.database.windows.net,1433; Initial Catalog =[xyzstart_db]; User Id=[xyzdb@ufwryy6r0y]; Password=[virAf89Hda];");
