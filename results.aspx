...
<html>
     ...
     void BindGrid(){
        OleDbDataAdapter display_algebra=new OleDbDataAdapter("SELECT student_id, name, school, score FROM participants WHERE category='Algebra' ORDER BY score DESC", dbconn);// 
        ...
        OleDbDataAdapter display_geometry=new OleDbDataAdapter("SELECT student_id, name, school, score FROM participants WHERE category='Geometry' ORDER BY score DESC", dbconn);// 
        ...
        OleDbDataAdapter display_precal=new OleDbDataAdapter("SELECT student_id, name, school, score FROM participants WHERE category='Precal' ORDER BY score DESC", dbconn);// 
        ...
        OleDbDataAdapter display_algebraGrp=new OleDbDataAdapter("SELECT team_id, school, algebra_g FROM teams ORDER BY algebra_g DESC", dbconn);// 
        ...
        OleDbDataAdapter display_geometryGrp=new OleDbDataAdapter("SELECT team_id, school, geometry_g FROM teams ORDER BY geometry_g DESC", dbconn);// 
        ...
        OleDbDataAdapter display_precalGrp=new OleDbDataAdapter("SELECT team_id, school, precal_g FROM teams ORDER BY precal_g DESC", dbconn);// 
        ...
        OleDbDataAdapter display_mixedGrp=new OleDbDataAdapter("SELECT team_id, school, mixed_g FROM teams ORDER BY mixed_g DESC", dbconn);// 
        ...
        OleDbDataAdapter display_team=new OleDbDataAdapter("SELECT team_id, school, team_score FROM teams ORDER BY team_score DESC", dbconn);// 
